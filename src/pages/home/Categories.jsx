        ...
        <div className="flex flex-col lg:flex-row gap-3  h-auto">
          ...
          <div className="space-y-2 w-full lg:w-1/2 h-full lg:h-1/2">
            <div className="flex md:flex-row flex-col gap-3 h-full  ">
              <div className="bg-[url(/images/category-2.jpg)]  h-[314px] w-full flex flex-col items-start justify-center px-6 lg:bg-center bg-no-repeat">
              ...
              <div className="bg-[url(/images/category-3.jpg)] h-[314px] w-full flex flex-col items-start justify-center px-6 lg:bg-center bg-no-repeat">
            ...
            <div className="flex gap-3 md:flex-row flex-col  h-full">
              <div className="bg-[url(/images/category-4.jpg)] h-[314px] w-full flex flex-col items-start justify-center px-6 lg:bg-center bg-no-repeat">
              ...
              <div className="bg-[url(/images/category-5.jpg)] h-[314px] w-full flex flex-col items-start justify-center px-6 lg:bg-center bg-no-repeat">
